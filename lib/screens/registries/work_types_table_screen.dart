...
class _WorkTypesTableScreenState extends State<WorkTypesTableScreen> {
  late List<WorkTypeEntryModel> _rows;
  var _saving = false;
  ...
  void initState() {
    ...
    _rows = List<WorkTypeEntryModel>.from(
      widget.catalog.workTypesFile?.model.types ?? const <WorkTypeEntryModel>[],
    );
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          setState(() {
            _rows.add(WorkTypeEntryModel(id: maxId + 1, name: 'Work_${maxId + 1}'));
          });
        },
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (v) {
                        ...
                        setState(() {
                          _rows[index] = WorkTypeEntryModel(id: id, name: row.name);
                        });
                      },
                    ),
                  ),
                ...
                DataCell(
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (v) {
                        setState(() {
                          _rows[index] = WorkTypeEntryModel(id: row.id, name: v);
                        });
                      },
                    ),
                  ),
