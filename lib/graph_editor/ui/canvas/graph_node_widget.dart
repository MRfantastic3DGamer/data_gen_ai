...
class _GraphNodeWidgetState extends State<GraphNodeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final nodeHeight = GraphLayoutMetrics.nodeHeaderHeight +
        ports.length * GraphLayoutMetrics.portRowHeight +
        12;
  ...
  void _handlePortTap(BuildContext context, port) {
  ...
  void _startConnection(BuildContext context, port) {
    final isOutput = port.direction == PortDirection.output;
    final layout = GraphLayoutCalculator.portLayouts(
  ...
  Offset _blockTopLeft() {
    ...
    return parentNode.position.toOffset().translate(
      ...
      parentHeight +
          GraphLayoutMetrics.contextPadding +
          blockIndex *
              (GraphLayoutMetrics.blockHeight + GraphLayoutMetrics.blockGap),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: _NodeCard(
        ...
        height: GraphLayoutMetrics.blockHeight,
        child: Column(
          children: ports
              .map(
                (port) => GraphPortWidget(
